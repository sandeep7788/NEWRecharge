...
//                    mItemList.txt_id.setText("_");
                    ...
                    mItemList.txt_id.setText(movie.getTransID().toString()+" ");
                    mItemList.txt_date.setText("on "+movie.getAddDate().toString());
                    mItemList.txt_recharge.setText("Recharge of "+movie.getRechargeAmount().toString());
