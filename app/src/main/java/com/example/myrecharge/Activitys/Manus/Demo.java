...
import com.example.myrecharge.Activitys.CustomAlertAdapter;
import com.example.myrecharge.Models.OperatorModel;
import com.example.myrecharge.R;
import java.util.ArrayList;

public class Demo extends Dialog implements AdapterView.OnItemClickListener {

    public Activity c;
    public Button dialog_cancel_btn;
    ...
    public Demo(Context context, final ArrayList<OperatorModel> TitleName, TextView textview){
        super(context);
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.operator_list_layout);
