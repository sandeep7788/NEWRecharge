...
open class Pay_Activity : AppCompatActivity(), DialogInterface.OnClickListener, OnItemClickListener
{
            ...
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                if(response.isSuccessful) {
                    ...
                    if (mJsonObject.getString("Error").toLowerCase().equals("false")){
                        ...
                        operatorDialog= Demo(this@Pay_Activity,operatorList,mainBinding.textView)
...
/*
    fun dialog(
        ...
        dialog_data.setContentView(R.layout.operator_list_layout)
